...
layout3=[
    [sg.Column(
        ...
        [sg.InputText(key='-EDITTEXT1-',visible=False,font=font_text,size=(20,10))],
        [sg.Button('Grass',pad=(0,0),key='-EDITBTN2-',font=font_btn)],
        [sg.InputText(key='-EDITTEXT2-',visible=False,font=font_text,size=(20,10))],
        [sg.Button('Walkway',pad=(0,0),key='-EDITBTN3-',font=font_btn)],
        [sg.InputText(key='-EDITTEXT3-',visible=False,font=font_text,size=(20,10))],
        [sg.Button('Tram tracks',pad=(0,0),key='-EDITBTN4-',font=font_btn)],
        [sg.InputText(key='-EDITTEXT4-',visible=False,font=font_text,size=(20,10))],
        [sg.Button('Sign',pad=(0,0),key='-EDITBTN5-',font=font_btn)],
        [sg.InputText(key='-EDITTEXT5-',visible=False,font=font_text,size=(20,10))],
